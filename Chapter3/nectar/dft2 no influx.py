...
lhs['max_dft1_transmission_rate']=lhs_preparation(0.5,0.9,num_of_simu,seed_num)
...
lhs['max_dft2_transmission_rate']=lhs_preparation(0.5,0.9,num_of_simu,seed_num)
