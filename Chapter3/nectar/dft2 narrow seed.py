...
lhs['min_resource']=lhs_preparation(200,300,num_of_simu,seed_num=None).astype(int)
lhs['max_resource']=lhs_preparation(400,600,num_of_simu,seed_num=None).astype(int)
lhs['max_fitness']=lhs_preparation(15,max_fitness,num_of_simu,seed_num=None).astype(int)
lhs['min_fitness']=lhs_preparation(7,min_fitness,num_of_simu,seed_num=None).astype(int)
lhs['max_dft1_transmission_rate']=lhs_preparation(0.5,0.9,num_of_simu,seed_num=None)
lhs['max_dft1_latency_period']=lhs_preparation(200,540,num_of_simu,seed_num=None).astype(int)
lhs['min_dft1_latency_period']=lhs_preparation(min_dft1_latency_period,180,num_of_simu,seed_num=None).astype(int)
lhs['dft1_fitness_decline_rate']=lhs_preparation(0.1,0.9,num_of_simu,seed_num=None)
lhs['dft1_fitness_decline_val']=lhs_preparation(1,5,num_of_simu,seed_num=None).astype(int)
lhs['max_dft2_transmission_rate']=lhs_preparation(0.5,0.9,num_of_simu,seed_num=None)
lhs['max_dft2_latency_period']=lhs_preparation(200,540,num_of_simu,seed_num=None).astype(int)
lhs['min_dft2_latency_period']=lhs_preparation(min_dft2_latency_period,180,num_of_simu,seed_num=None).astype(int)
lhs['dft2_fitness_decline_rate']=lhs_preparation(0.1,0.9,num_of_simu,seed_num=None)
lhs['dft2_fitness_decline_val']=lhs_preparation(1,5,num_of_simu,seed_num=None).astype(int)
